        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder:
                  border(context, color: Theme.of(context).primaryColor.withOpacity(0.5), circular: radius),
...
InputBorder border(BuildContext context, {Color? color, double? circular}) => OutlineInputBorder(
      ...
      borderRadius: BorderRadius.circular(circular?.sp ?? radius.sp),
    );
